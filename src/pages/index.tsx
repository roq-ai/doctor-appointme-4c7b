  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience healthcare convenience like never before with Doctor Appointment System. Simplifying your medical appointments, one click at a time."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1651008376811-b90baee60c1f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxkb2N0b3J8ZW58MHx8fHwxNjk4MjE0NzAzfDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience healthcare convenience like never before with Doctor Appointment System. Simplifying your medical appointments, one click at a time.`}
            </Text>
            <Box
            ...
            >
              <Stack direction={{ md: 'row', base: 'column' }} spacing="1.5rem">
                ...
                <Card userTypeName="Client" type="client" abilities={appConfig.customerAbilities} />
              </Stack>
            </Box>
          </Box>
          <Box pt={4}>
