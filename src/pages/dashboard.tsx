...
import { useRoqPlatformUserProfiles, useMedicalStaffCount, useClientKCount, useInsuranceProviderCount } from 'lib/roq';

import { ClientKListPage as ShowCaseList } from 'pages/client-ks';
...
function DashboardPage() {
  ...
  const clientKStat = useClientKCount();
  ...
  const statResults: { title: string; result: number; change: number; isLoading: boolean }[] = [
    ...
    {
      title: 'Client KS',
      result: clientKStat?.data,
      isLoading: clientKStat.isLoading,
      change: Math.floor(Math.random() * (100 - 40 + 1) + 40),
    },
    {
          ...
          <Stack direction="column" spacing={8} flex={{ base: 1, md: 7 }}>
            ...
            <Box>
              <Flex mb={4} justifyContent={'space-between'}>
                ...
                <NextLink href={`client-ks`} passHref legacyBehavior>
                  <Button
